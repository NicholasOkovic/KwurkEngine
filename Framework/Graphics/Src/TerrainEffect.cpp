...
{
	ASSERT(mCamera != nullptr, "Terrain effect: must have a camera");
...
void TerrainEffect::SetDirectionalLighting(const DirectionalLight& directionalLight)
{
