...
inline btVector3 TobtVector3(const KwurkEngine::Math::Vector3& v)
{
	return btVector3(v.x, v.y, v.z);
}

inline KwurkEngine::Math::Vector3 ToVector3(const btVector3& v)
{
	return
	{
...
inline btQuaternion TobtQuaternion(const KwurkEngine::Math::Quaternion& q)
{
	return btQuaternion(q.x, q.y, q.z, q.w);
}

inline KwurkEngine::Math::Quaternion ToQuaternion(const btQuaternion& q)
{
	return
	{
...
inline KwurkEngine::Color ToColor(const btVector3& c)
{
	return
	{
