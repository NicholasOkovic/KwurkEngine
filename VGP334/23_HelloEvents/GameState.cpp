...
void GameState::Initialize()
{
	...
	mSpacePressedEventId = em->AddListerner(EventType::SpacePressed, std::bind(&GameState::OnSpacePressedEvent, this, std::placeholders::_1));
...
void GameState::Update(float deltaTime)
{
	...
	if (InputSystem::Get()->IsKeyPressed(KeyCode::B))
	{
...
void GameState::OnSpacePressedEvent(const KwurkEngine::Event& e)
{
